...
from llm_config import LLM_MODELS, get_all_available_models, add_offline_model, get_available_cloud_models
...
def api_available_models():
    ...
    # Dynamically check for Ollama availability
